...
import { SERVICE_TYPES } from "src/common/constants/service-type.constant";
import { REGIONS } from "src/common/constants/region.constant";
...
export class MoverProfileController {
  ...
  @ApiOperation({ summary: "기사님 프로필 등록" })
